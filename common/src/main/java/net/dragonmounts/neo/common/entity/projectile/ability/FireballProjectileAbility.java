...
public class FireballProjectileAbility extends DragonProjectileAbility {
    private final int explosionPower;

    public FireballProjectileAbility(int minChargeTicks, int cooldownTicks, int explosionPower) {
    ...
    public void fire(TameableDragonEntity dragon, ServerLevel level, Vec3 origin, Vec3 aim, float power) {
        ...
        LargeFireball ball = new LargeFireball(level, dragon, movement, this.explosionPower);
