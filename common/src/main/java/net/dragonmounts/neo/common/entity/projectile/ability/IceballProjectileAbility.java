...
public class IceballProjectileAbility extends DragonProjectileAbility {
    private final int explosionPower;

    public IceballProjectileAbility(int minChargeTicks, int cooldownTicks, int explosionPower) {
    ...
    public void fire(TameableDragonEntity dragon, ServerLevel level, Vec3 origin, Vec3 aim, float power) {
        ...
        DragonIceballEntity ball = new DragonIceballEntity(level, dragon, movement);
