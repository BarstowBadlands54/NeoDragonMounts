...
public final class DragonScaleArmorSuit implements DragonTypified, ArmorEffectSource {
    ...
    public DragonScaleArmorSuit(
        ...
        var key = info.helmet();
        this.helmet = Registry.register(registry, key, factory.makeArmor(this, ArmorItem.Type.HELMET, new Item.Properties()));
        key = info.chestplate();
        this.chestplate = Registry.register(registry, key, factory.makeArmor(this, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
        key = info.leggings();
        this.leggings = Registry.register(registry, key, factory.makeArmor(this, ArmorItem.Type.LEGGINGS, new Item.Properties()));
        key = info.boots();
        this.boots = Registry.register(registry, key, factory.makeArmor(this, ArmorItem.Type.BOOTS, new Item.Properties()));
    }
