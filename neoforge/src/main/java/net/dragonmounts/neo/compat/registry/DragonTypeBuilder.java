...
public final class DragonTypeBuilder {
    private static final ObjectArrayList<net.dragonmounts.neo.compat.registry.DragonType> INSTANCES = new ObjectArrayList<>();
    ...
    public <T extends net.dragonmounts.neo.compat.registry.DragonType> T register(
